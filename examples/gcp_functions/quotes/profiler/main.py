...
def scrap_quotes(event, context):
    ...
    url = "https://europe-west3-faas-355111.cloudfunctions.net/quotes-dev-save_quotes"
        ...
        task = tasks.Task(
            http_request=tasks.HttpRequest(
                ...
                oidc_token=tasks.OidcToken(
                    ...
                    audience="https://europe-west3-faas-355111.cloudfunctions.net/quotes-dev-save_quotes")
        ))
